...
bucket_name = ENV['BUCKET_NAME'] || "mybuckkio"  # Fetching bucket name with a default fallback
...
number_of_files.times.each do |i|
  ...
  output_path = "/home/ishan/Desktop/VsCode/AWS SAA/sdk/ruby/#{filename}" # Specifying the output path
